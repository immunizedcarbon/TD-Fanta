...
class Soldier private constructor(gameEngine: GameEngine) : Enemy(gameEngine, ENEMY_PROPERTIES), SpriteTransformation {
    class Factory : EntityFactory() {
        override fun create(gameEngine: GameEngine): Entity = Soldier(gameEngine)
    }
    ...
    override fun getTextId(): Int = R.string.enemy_soldier
